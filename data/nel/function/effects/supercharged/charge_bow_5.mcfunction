advancement revoke @s only nel:enchantments/supercharged_using_5
...
execute if score @s ne_progress.supercharged matches 180 run function nel:effects/supercharged/stack_5