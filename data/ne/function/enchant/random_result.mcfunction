...
execute if score #enchant_result ne matches 7..16 run scoreboard players add #ench_origin_level ne 1
execute if score #enchant_result ne matches 17..20 run playsound minecraft:block.note_block.didgeridoo player @a ~ ~ ~ 1 0.8