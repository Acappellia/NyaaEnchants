execute store result score #ench_origin_level ne run data get entity @s item.components."minecraft:stored_enchantments"."minecraft:binding_curse"
...
execute store result entity @s item.components."minecraft:stored_enchantments"."minecraft:binding_curse" int 1 run scoreboard players get #ench_origin_level ne