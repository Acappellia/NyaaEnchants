execute store result score #ench_origin_level ne run data get entity @s item.components."minecraft:stored_enchantments".levels."minecraft:frost_walker"
...
execute store result entity @s item.components."minecraft:stored_enchantments".levels."minecraft:frost_walker" int 1 run scoreboard players get #ench_origin_level ne