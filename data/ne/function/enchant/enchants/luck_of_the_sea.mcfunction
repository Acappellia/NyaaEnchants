execute if data entity @s item.components."minecraft:stored_enchantments"."minecraft:luck_of_the_sea" run function ne:enchant/enchants_store/luck_of_the_sea
execute unless data entity @s item.components."minecraft:enchantments"."minecraft:luck_of_the_sea" run return -1

execute store result score #ench_origin_level ne run data get entity @s item.components."minecraft:enchantments"."minecraft:luck_of_the_sea"
execute store result score #ench_added_level ne run data get storage ne:tmp ench_component."minecraft:stored_enchantments"."minecraft:luck_of_the_sea"
...
execute store result entity @s item.components."minecraft:enchantments"."minecraft:luck_of_the_sea" int 1 run scoreboard players get #ench_origin_level ne