execute if data entity @s item.components."minecraft:stored_enchantments"."ne:location_test" run function ne:enchant/enchants_store/location_test
execute unless data entity @s item.components."minecraft:enchantments"."ne:location_test" run return -1

execute store result score #ench_origin_level ne run data get entity @s item.components."minecraft:enchantments"."ne:location_test"
execute store result score #ench_added_level ne run data get storage ne:tmp ench_component."minecraft:stored_enchantments"."ne:location_test"
...
execute store result entity @s item.components."minecraft:enchantments"."ne:location_test" int 1 run scoreboard players get #ench_origin_level ne