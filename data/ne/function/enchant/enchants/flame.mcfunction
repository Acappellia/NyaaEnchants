execute if data entity @s item.components."minecraft:stored_enchantments".levels."minecraft:flame" run function ne:enchant/enchants_store/flame
execute unless data entity @s item.components."minecraft:enchantments".levels."minecraft:flame" run return -1

execute store result score #ench_origin_level ne run data get entity @s item.components."minecraft:enchantments".levels."minecraft:flame"
execute store result score #ench_added_level ne run data get storage ne:tmp ench_component."minecraft:stored_enchantments".levels."minecraft:flame"
...
execute store result entity @s item.components."minecraft:enchantments".levels."minecraft:flame" int 1 run scoreboard players get #ench_origin_level ne