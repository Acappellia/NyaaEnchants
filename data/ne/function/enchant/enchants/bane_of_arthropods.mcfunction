execute if data entity @s item.components."minecraft:stored_enchantments"."minecraft:bane_of_arthropods" run function ne:enchant/enchants_store/bane_of_arthropods
execute unless data entity @s item.components."minecraft:enchantments"."minecraft:bane_of_arthropods" run return -1

execute store result score #ench_origin_level ne run data get entity @s item.components."minecraft:enchantments"."minecraft:bane_of_arthropods"
execute store result score #ench_added_level ne run data get storage ne:tmp ench_component."minecraft:stored_enchantments"."minecraft:bane_of_arthropods"
...
execute store result entity @s item.components."minecraft:enchantments"."minecraft:bane_of_arthropods" int 1 run scoreboard players get #ench_origin_level ne