execute if data entity @s item.components."minecraft:stored_enchantments"."minecraft:blast_protection" run function ne:enchant/enchants_store/blast_protection
execute unless data entity @s item.components."minecraft:enchantments"."minecraft:blast_protection" run return -1

execute store result score #ench_origin_level ne run data get entity @s item.components."minecraft:enchantments"."minecraft:blast_protection"
execute store result score #ench_added_level ne run data get storage ne:tmp ench_component."minecraft:stored_enchantments"."minecraft:blast_protection"
...
execute store result entity @s item.components."minecraft:enchantments"."minecraft:blast_protection" int 1 run scoreboard players get #ench_origin_level ne