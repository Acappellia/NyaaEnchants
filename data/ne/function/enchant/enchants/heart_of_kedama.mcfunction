execute if data entity @s item.components."minecraft:stored_enchantments"."nel:heart_of_kedama" run function ne:enchant/enchants_store/heart_of_kedama
execute unless data entity @s item.components."minecraft:enchantments"."nel:heart_of_kedama" run return -1

execute store result score #ench_origin_level ne run data get entity @s item.components."minecraft:enchantments"."nel:heart_of_kedama"
execute store result score #ench_added_level ne run data get storage ne:tmp ench_component."minecraft:stored_enchantments"."nel:heart_of_kedama"
...
execute store result entity @s item.components."minecraft:enchantments"."nel:heart_of_kedama" int 1 run scoreboard players get #ench_origin_level ne