execute if data entity @s item.components."minecraft:stored_enchantments"."minecraft:lure" run function ne:enchant/enchants_store/lure
execute unless data entity @s item.components."minecraft:enchantments"."minecraft:lure" run return -1
