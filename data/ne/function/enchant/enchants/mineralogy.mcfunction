execute if data entity @s item.components."minecraft:stored_enchantments".levels."nel:mineralogy" run function ne:enchant/enchants_store/mineralogy
execute unless data entity @s item.components."minecraft:enchantments".levels."nel:mineralogy" run return -1

execute store result score #ench_origin_level ne run data get entity @s item.components."minecraft:enchantments".levels."nel:mineralogy"
execute store result score #ench_added_level ne run data get storage ne:tmp ench_component."minecraft:stored_enchantments".levels."nel:mineralogy"
...
execute store result entity @s item.components."minecraft:enchantments".levels."nel:mineralogy" int 1 run scoreboard players get #ench_origin_level ne