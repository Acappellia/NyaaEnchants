execute if data entity @s item.components."minecraft:stored_enchantments"."nel:potion_arrow" run function ne:enchant/enchants_store/potion_arrow
execute unless data entity @s item.components."minecraft:enchantments"."nel:potion_arrow" run return -1

execute store result score #ench_origin_level ne run data get entity @s item.components."minecraft:enchantments"."nel:potion_arrow"
execute store result score #ench_added_level ne run data get storage ne:tmp ench_component."minecraft:stored_enchantments"."nel:potion_arrow"
...
execute store result entity @s item.components."minecraft:enchantments"."nel:potion_arrow" int 1 run scoreboard players get #ench_origin_level ne