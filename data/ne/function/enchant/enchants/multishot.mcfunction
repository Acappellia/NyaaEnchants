execute if data entity @s item.components."minecraft:stored_enchantments".levels."minecraft:multishot" run function ne:enchant/enchants_store/multishot
execute unless data entity @s item.components."minecraft:enchantments".levels."minecraft:multishot" run return -1

execute store result score #ench_origin_level ne run data get entity @s item.components."minecraft:enchantments".levels."minecraft:multishot"
...
execute store result entity @s item.components."minecraft:enchantments".levels."minecraft:multishot" int 1 run scoreboard players get #ench_origin_level ne