execute if data entity @s item.components."minecraft:custom_data".ne_break run function ne:upgrade/break_upgrade
execute unless data entity @s item.components."minecraft:custom_data".ne_break run function ne:upgrade/break_init
